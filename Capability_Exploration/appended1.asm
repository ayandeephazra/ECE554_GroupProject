...
###################################
# Testing for 16-bit parity check #
###################################
...
#    y = y ^ (y >> 4);
#    y = y ^ (y >> 8);
#    y = y ^ (y >> 16);	# for 32 bits, remove for 16 bits
...
# changed XOR opcode in asmbl.pl, added XOR to common_params.inc and id.v(prob can remove)
...
ANDI R4, R3, 0x01	# (y & 1)
B gt, SEND_LOW_METEOR
B eq, SEND_HIGH_METEOR
B uncond, FAIL
#SUB R5, R4, R6		# (y & 1) == 1?	# if 1 is returned, parity is odd
#B eq, PASS
#B neq, FAIL
...
#LLB R1, 0x07	# n = 7 (is is parity or not?)
#LLB R3, 0x00	# parity = 0
#LLB R5, 0x01	# should be odd parity by returning 1
# 0000 NAND 0000 = ffff
#XOR R4, R1, R3
# n will be in R3
# parity will be in R5
PARITY_CHECK: 

#ANDN R8, R3, R3 	# parity = !parity

#SUBI R4, R1, 0x01	# R4 = (n - 1)
#AND R2, R1, R4		# R2 = n(R1) & (R4) (n - 1) 

#B eq, PARITY_CHECK	# while n is zero, continue
